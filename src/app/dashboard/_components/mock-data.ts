...
export const MOCK_TASKS: MockTask[] = [
  ...
  },
  {
    ...
    start_date: null,
    estimated_hours: 8,
    description: "Waiting on final assets",
    created_by: "u1",
  },
  // This month
  {
    ...
    start_date: fmt(addDays(today, 8)),
    estimated_hours: 4,
    description: null,
    created_by: "u1",
  },
  {
    id: "t9",
    title: "Icon set — 48 icons",
    project_id: "p3",
    status: "todo",
    priority: 2,
    due_date: fmt(addDays(today, 14)),
  ...
  },
  {
    ...
    priority: 4,
    due_date: fmt(addDays(today, -2)),
    start_date: fmt(addDays(today, -4)),
    estimated_hours: 5,
    description: null,
    created_by: "u1",
  },
...
// Project colors for visual identity
export const PROJECT_COLORS: Record<
  string,
  { accent: string; glow: string; muted: string }
> = {
  p1: {
    accent: "#E8C547",
  ...
  p2: {
    accent: "#47B5E8",
    glow: "rgba(71, 181, 232, 0.4)",
    muted: "rgba(71, 181, 232, 0.15)",
  }, // Cyan
  p3: {
    accent: "#E85C47",
    glow: "rgba(232, 92, 71, 0.4)",
    muted: "rgba(232, 92, 71, 0.15)",
  }, // Coral
};
